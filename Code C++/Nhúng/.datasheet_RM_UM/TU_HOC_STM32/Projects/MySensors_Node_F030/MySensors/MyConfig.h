...
//#define MY_RF24_CHANNEL	       122
  #define MY_RF24_CHANNEL	       38

  #define MY_RF24_DATARATE  RF24_2MBPS
//#define MY_RF24_DATARATE  RF24_250KBPS

  #define MY_RF24_BASE_RADIO_ID   0x55,0x66
//#define MY_RF24_BASE_RADIO_ID   0xE0,0xE1
//#define MY_RF24_BASE_RADIO_ID   0x1F,0x1E


  #define MY_RF24_ADDR_WIDTH      2
 ...
 */
  ...
  #else
    #define MY_RF24_CE_PIN 	3 //15	//9		// chinh sua
  #endif
#endif
 ...
 */
  ...
  #else
    #define MY_RF24_CS_PIN  4//1		//10	// chinh sua
  #endif
#endif
...
*
* This feature is currently not supported for RFM69 and RS485, for RF24 has to be defined.
*/
 ...
 */
    ...
    #define MY_RX_MESSAGE_BUFFER_SIZE  (16)
  #endif
#endif
...
#define MY_SOFT_SPI_SCK_PIN   5  //13	//14	// chinh sua
#endif
...
#define MY_SOFT_SPI_MISO_PIN  6  //14	//16	//chinh sua
#endif
...
#define MY_SOFT_SPI_MOSI_PIN  7 //15	//15	// chinh sua
#endif
...
#define MY_SIGNING_REQUEST_SIGNATURES
#define MY_SIGNING_GW_REQUEST_SIGNATURES_FROM_ALL
#define MY_SIGNING_NODE_WHITELISTING {{.nodeId = GATEWAY_ADDRESS,.serial = {0x09,0x08,0x07,0x06,0x0F,0x04,0x03,0x02,0x01}}}
