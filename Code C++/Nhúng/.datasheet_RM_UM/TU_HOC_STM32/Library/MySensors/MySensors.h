...
// chinh sua: thay thế cho MyHwSAMD, MyHwAVR
#ifdef STM32F0XX
  #include "MyHwSTM32.h"
#endif
...
// chỉnh sửa: //#include "core/MyIndication.cpp"
...
// chỉnh sửa: //#include "core/MySigning.cpp"
#include "core/MySigning.h"


//#include "drivers/ATSHA204/sha256.cpp"  // chỉnh sửa
...
#error You must specify MY_CONTROLLER_IP_ADDRESS or MY_CONTROLLER_URL_ADDRESS for UDP
  ...
  // GATEWAY - COMMON FUNCTIONS
  #include "core/MyGatewayTransport.cpp"
//  #include "core/MyGatewayTransport.h"   // chỉnh sửa

  // chỉnh sửa #include "core/MyProtocolMySensors.cpp"
...
// chỉnh sửa //#include "core/MyTransport.cpp"
...
// chỉnh sửa: #include "drivers/RF24/RF24.cpp"
#include "drivers/RF24/RF24.h"

// chỉnh sửa: #include "MyTransportNRF24.cpp"
...
#include "core/MyMessage.h"     // chỉnh sửa
#include "core/MySensorsCore.h" // chỉnh sửa

//#include <Arduino.h>  // chỉnh sửa
    ...
    #include "core/MyMainDefault.h" // chỉnh sửa
  #endif
#endif
