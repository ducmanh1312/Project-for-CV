...
/**********************************************************************/
  ...
  #ifdef STM32F0XX
    #if   RF24_IRQ_PIN < 2
      #define EXTI_IRQHandler    EXTI0_1_IRQHandler
    #elif RF24_IRQ_PIN < 4
      #define EXTI_IRQHandler    EXTI2_3_IRQHandler
    ...
    #elif RF24_IRQ_PIN == 3
      #define EXTI_IRQHandler    EXTI3_IRQHandler
    #elif RF24_IRQ_PIN == 4
      #define EXTI_IRQHandler    EXTI4_IRQHandler
    #elif RF24_IRQ_PIN < 10
