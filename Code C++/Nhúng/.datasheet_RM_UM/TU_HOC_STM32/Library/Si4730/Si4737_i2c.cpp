...
#define SI4730_RST_PORT    GPIOB
#define SI4730_RST_PIN     15
#define SI4730_RST_LOW()   SI4730_RST_PORT->BRR  = _BV(SI4730_RST_PIN)
#define SI4730_RST_HIGH()  SI4730_RST_PORT->BSRR = _BV(SI4730_RST_PIN)
...
//	printf("Init Si4737 at _i2caddr=");
//	printf("0x%X", _i2caddr);
//	printf("\n");


	//Reset pinout config
	//pinMode(_pinReset, OUTPUT);
  F103_GPIO_pinMode_output(SI4730_RST_PORT, SI4730_RST_PIN, GPIO_Mode_Out_PP | GPIO_Speed_10MHz);
...
//  printf("Wire has begun, I2C now active\n");
...
//    arg7,
//  };
//  Wire.send(_i2caddr, data, sizeof(data));
...
//	block[3] = word(_response[10], _response[11]);
	...
	block[0] = HL16(_response[4], _response[5]);
	block[1] = HL16(_response[6], _response[7]);
	block[2] = HL16(_response[8], _response[9]);
	block[3] = HL16(_response[10], _response[11]);
...
//  Wire.receive(_i2caddr, response, 16);
...
word Si4737::getProperty(word property){
	...
	return HL16(_response[2], _response[3]);
}
...
//	printf("Set mode to ");
	...
	switch(_mode){
	case SI4735_MODE_FM:
//	  printf("SI4735_MODE_FM\n");
		sendCommand(SI4735_CMD_POWER_UP,
			SI4735_FUNC_FM | SI4735_FLG_XOSCEN,
			SI4735_OUT_ANALOG);
		break;

	case SI4735_MODE_AM:
//	  printf("SI4735_MODE_AM\n");
		sendCommand(SI4735_CMD_POWER_UP,
...
void Si4737::enableRDS(void){
	...
	if(_mode == SI4735_MODE_FM) {
//		setProperty(SI4735_PROP_FM_RDS_INT_SOURCE, word(0x00, SI4735_FLG_RDSRECV));
...
//			SI4735_FLG_BLETHD_35, SI4735_FLG_RDSEN));
		...
		setProperty(SI4735_PROP_FM_RDS_INT_SOURCE, HL16(0x00, SI4735_FLG_RDSRECV));
		setProperty(SI4735_PROP_FM_RDS_INT_FIFO_COUNT, HL16(0x00, 0x04));
		setProperty(SI4735_PROP_FM_RDS_CONFIG, HL16(SI4735_FLG_BLETHA_35 |
			SI4735_FLG_BLETHB_35 | SI4735_FLG_BLETHC_35 |
			SI4735_FLG_BLETHD_35, SI4735_FLG_RDSEN));
	};
}
